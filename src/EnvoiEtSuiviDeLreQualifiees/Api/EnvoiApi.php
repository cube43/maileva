...
/**
     ...
     * Création d&#39;un envoi
     *
     * @param  \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingCreation $sending_creation Nouvel envoi (required)
     ...
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingResponse|\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingResponse|\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse|\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse|\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function findSendingsWithHttpInfo($start_index = 1, $count = 50, $sort = null, $desc = null, string $contentType = self::contentTypes['findSendings'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingUpdate $sending_update sending_update (required)
     ...
     *
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\SendingUpdate $sending_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateSender'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\ApiException on non-2xx response
     * @throws \InvalidArgumentException
