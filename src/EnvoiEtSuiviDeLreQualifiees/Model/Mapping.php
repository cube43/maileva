...
class Mapping implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'start_row' => 'float',
        'data' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\MappingDataInner[]'
    ];
    ...
    {
        $this->setIfExists('start_row', $data ?? [], null);
    ...
    */
     ...
     * Sets start_row
     *
     * @param float|null $start_row Première ligne de données
     *
     * @return self
     */
    public function setStartRow($start_row)
    {
        if (is_null($start_row)) {
            throw new \InvalidArgumentException('non-nullable start_row cannot be null');
        }
     ...
     * Gets data
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\MappingDataInner[]|null
     */
     ...
     * Sets data
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\MappingDataInner[]|null $data Mapping des colonnes
     *
     * @return self
     */
