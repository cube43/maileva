...
/**
 * AddressesImportsRecipient Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressesImportsRecipient implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addresses_imports_recipient';
    ...
    protected static $openAPITypes = [
        ...
        'company' => 'string',
        'status' => 'string',
        'pages_range' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientPagesRange',
        'errors' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto[]',
        'custom_fields' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientCustomFieldsInner[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('pages_range', $data ?? [], null);
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if ((!preg_match("/^[\\w]{1,}[\\w.+-]{0,}@[\\w-]{2,}([.][a-zA-Z]{2,}|[.][\\w-]{2,}[.][a-zA-Z]{2,})+$/", $email))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling AddressesImportsRecipient., must conform to the pattern /^[\\w]{1,}[\\w.+-]{0,}@[\\w-]{2,}([.][a-zA-Z]{2,}|[.][\\w-]{2,}[.][a-zA-Z]{2,})+$/.");
        }
     ...
     * Gets pages_range
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientPagesRange|null
     */
     ...
     * Sets pages_range
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientPagesRange|null $pages_range pages_range
     *
     * @return self
     */
    public function setPagesRange($pages_range)
    {
        if (is_null($pages_range)) {
            throw new \InvalidArgumentException('non-nullable pages_range cannot be null');
        }
     ...
     * Gets errors
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto[]|null
     */
     ...
     * Sets errors
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ErrorsDto[]|null $errors Erreurs trouvées sur l'adresse du destinataire
     *
     * @return self
     */
     ...
     * Gets custom_fields
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientCustomFieldsInner[]|null
     */
     ...
     * Sets custom_fields
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImportsRecipientCustomFieldsInner[]|null $custom_fields custom_fields
     *
     * @return self
     */
