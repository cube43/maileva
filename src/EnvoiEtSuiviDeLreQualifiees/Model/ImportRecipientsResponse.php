...
/**
 * ImportRecipientsResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ImportRecipientsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'import_recipients_response';
    ...
    protected static $openAPITypes = [
        'accepted_import' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ImportRecipientResponse[]'
    ];
    ...
    protected static $attributeMap = [
        'accepted_import' => 'accepted_import'
    ];
    ...
    protected static $setters = [
        'accepted_import' => 'setAcceptedImport'
    ];
    ...
    protected static $getters = [
        'accepted_import' => 'getAcceptedImport'
    ];
    ...
    {
        $this->setIfExists('accepted_import', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets accepted_import
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ImportRecipientResponse[]|null
     */
    public function getAcceptedImport()
    {
        return $this->container['accepted_import'];
    }

    /**
     * Sets accepted_import
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\ImportRecipientResponse[]|null $accepted_import accepted_import
     *
     * @return self
     */
    public function setAcceptedImport($accepted_import)
    {
        if (is_null($accepted_import)) {
            throw new \InvalidArgumentException('non-nullable accepted_import cannot be null');
        }
        $this->container['accepted_import'] = $accepted_import;
