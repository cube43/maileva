...
/**
 * AddressesImports Class Doc Comment
 *
 * @category Class
 ...
 */
class AddressesImports implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'addresses_imports';
    ...
    protected static $openAPITypes = [
        'addresses_imports' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImport[]',
        'paging' => '\Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\Paging'
    ];
    ...
    protected static $attributeMap = [
        'addresses_imports' => 'addresses_imports',
        'paging' => 'paging'
    ];
    ...
    protected static $setters = [
        'addresses_imports' => 'setAddressesImports',
        'paging' => 'setPaging'
    ];
    ...
    protected static $getters = [
        'addresses_imports' => 'getAddressesImports',
        'paging' => 'getPaging'
    ];
    ...
    {
        $this->setIfExists('addresses_imports', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['addresses_imports'] === null) {
            $invalidProperties[] = "'addresses_imports' can't be null";
        }
    ...
    /**
     * Gets addresses_imports
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImport[]
     */
    public function getAddressesImports()
    {
        return $this->container['addresses_imports'];
    }

    /**
     * Sets addresses_imports
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\AddressesImport[] $addresses_imports addresses_imports
     *
     * @return self
     */
    public function setAddressesImports($addresses_imports)
    {
        if (is_null($addresses_imports)) {
            throw new \InvalidArgumentException('non-nullable addresses_imports cannot be null');
        }
        $this->container['addresses_imports'] = $addresses_imports;
     ...
     * Gets paging
     *
     * @return \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\Paging
     */
     ...
     * Sets paging
     *
     * @param \Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees\Model\Paging $paging paging
     *
     * @return self
     */
