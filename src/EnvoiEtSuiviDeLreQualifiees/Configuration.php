...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.maileva.com/electronic_qualified_registered_mail/v1';
    ...
    {
        $report  = 'PHP SDK (Cube43\Component\MailEva\EnvoiEtSuiviDeLreQualifiees) Debug Report:' . PHP_EOL;
