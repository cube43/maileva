...
/**
     ...
     * @param  \Cube43\Component\MailEva\Model\CreateDocumentRequest $create_document_request create_document_request (optional)
     ...
     * @return \Cube43\Component\MailEva\Model\DocumentResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     *
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  \Cube43\Component\MailEva\Model\CreateDocumentRequest $create_document_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createDocument'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\DocumentResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function createDocumentWithHttpInfo($sending_id, $create_document_request = null, string $contentType = self::contentTypes['createDocument'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Cube43\Component\MailEva\Model\DocumentResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\DocumentResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\DocumentResponse', []),
            ...
            $returnType = '\Cube43\Component\MailEva\Model\DocumentResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\DocumentResponse',
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\DocumentResponse|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\DocumentResponse|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\DocumentsResponse|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\DocumentsResponse|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentsWithHttpInfo($sending_id, $start_index = 1, $count = 30, $sort = null, $desc = null, string $contentType = self::contentTypes['getDocuments'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\DocumentsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\DocumentsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\DocumentsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\DocumentsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\DocumentsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
