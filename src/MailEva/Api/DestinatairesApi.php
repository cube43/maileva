...
/**
     ...
     * @param  \Cube43\Component\MailEva\Model\RecipientCreation $recipient_creation Nouveau destinataire (required)
     ...
     * @return \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\RecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\RecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteAllRecipientsWithHttpInfo($sending_id, string $contentType = self::contentTypes['deleteAllRecipients'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 204:
                    if ('\Cube43\Component\MailEva\Model\RecipientsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\RecipientsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\RecipientsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\RecipientsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 204:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\RecipientsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\RecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\RecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  \Cube43\Component\MailEva\Model\ImportRecipients $import_recipients import_recipients (optional)
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\ImportRecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     *
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  \Cube43\Component\MailEva\Model\ImportRecipients $import_recipients (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['sendingsSendingIdRecipientsImportsPost'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\ImportRecipientsResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendingsSendingIdRecipientsImportsPostWithHttpInfo($sending_id, $import_recipients = null, string $contentType = self::contentTypes['sendingsSendingIdRecipientsImportsPost'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if ('\Cube43\Component\MailEva\Model\ImportRecipientsResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\ImportRecipientsResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\ImportRecipientsResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\ImportRecipientsResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\ImportRecipientsResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  string $recipient_id Identifiant du destinataire (required)
     * @param  \Cube43\Component\MailEva\Model\RecipientUpdate $recipient_update recipient_update (required)
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\SendingResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @param  string $sending_id Identifiant de l&#39;envoi (required)
     * @param  string $recipient_id Identifiant du destinataire (required)
     * @param  \Cube43\Component\MailEva\Model\RecipientUpdate $recipient_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateRecipient'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\SendingResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
