...
/**
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\AddressesImport|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\AddressesImport|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function addressesImportsAddressesImportIdGetWithHttpInfo($addresses_import_id, string $contentType = self::contentTypes['addressesImportsAddressesImportIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\AddressesImport' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\AddressesImport' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\AddressesImport', []),
            ...
            $returnType = '\Cube43\Component\MailEva\Model\AddressesImport';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\AddressesImport',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\AddressesImportsRecipients|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\AddressesImportsRecipients|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function addressesImportsAddressesImportIdRecipientsGetWithHttpInfo($addresses_import_id, string $contentType = self::contentTypes['addressesImportsAddressesImportIdRecipientsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\AddressesImportsRecipients' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\AddressesImportsRecipients' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\AddressesImportsRecipients', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\AddressesImportsRecipients';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\AddressesImportsRecipients',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\AddressesImportsRecipient|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\AddressesImportsRecipient|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function addressesImportsAddressesImportIdRecipientsRecipientIdGetWithHttpInfo($addresses_import_id, $recipient_id, string $contentType = self::contentTypes['addressesImportsAddressesImportIdRecipientsRecipientIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\AddressesImportsRecipient' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\AddressesImportsRecipient' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\AddressesImportsRecipient', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\AddressesImportsRecipient';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\AddressesImportsRecipient',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  string $addresses_import_id Identifiant de l&#39;import (required)
     * @param  string $recipient_id Identifiant du destinataire (required)
     * @param  \Cube43\Component\MailEva\Model\AddressesImportsRecipientUpdate $addresses_imports_recipient_update addresses_imports_recipient_update (required)
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @param  string $addresses_import_id Identifiant de l&#39;import (required)
     * @param  string $recipient_id Identifiant du destinataire (required)
     * @param  \Cube43\Component\MailEva\Model\AddressesImportsRecipientUpdate $addresses_imports_recipient_update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addressesImportsAddressesImportIdRecipientsRecipientIdPatch'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\RecipientResponse|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function addressesImportsAddressesImportIdRecipientsRecipientIdPatchWithHttpInfo($addresses_import_id, $recipient_id, $addresses_imports_recipient_update, string $contentType = self::contentTypes['addressesImportsAddressesImportIdRecipientsRecipientIdPatch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\RecipientResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\RecipientResponse' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\RecipientResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\RecipientResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\RecipientResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\AddressesImports|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\AddressesImports|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function addressesImportsGetWithHttpInfo(string $contentType = self::contentTypes['addressesImportsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Cube43\Component\MailEva\Model\AddressesImports' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Cube43\Component\MailEva\Model\AddressesImports' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\Cube43\Component\MailEva\Model\AddressesImports', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\Cube43\Component\MailEva\Model\AddressesImports';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Cube43\Component\MailEva\Model\AddressesImports',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  \Cube43\Component\MailEva\Model\AddressesImportInput $addresses_import_input addresses_import_input (optional)
     ...
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Cube43\Component\MailEva\Model\AddressesImport|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto
     */
     ...
     * Démarrer un import étape par étape
     *
     * @param  \Cube43\Component\MailEva\Model\AddressesImportInput $addresses_import_input (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['addressesImportsPost'] to see the possible values for this operation
     *
     * @throws \Cube43\Component\MailEva\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Cube43\Component\MailEva\Model\AddressesImport|\Cube43\Component\MailEva\Model\ErrorsDto|\Cube43\Component\MailEva\Model\ErrorsDto, HTTP status code, HTTP response headers (array of strings)
     */
