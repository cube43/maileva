...
class RecipientCreation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['legal_status'] === null) {
            $invalidProperties[] = "'legal_status' can't be null";
        }
     ...
     * Sets legal_status
     *
     * @param string $legal_status Type de destinataire
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string $first_name Prénom du destinataire
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecipientCreation., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling RecipientCreation., must be bigger than or equal to 1.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Nom du destinataire
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecipientCreation., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling RecipientCreation., must be bigger than or equal to 1.');
        }
    ...
    public function setEmail($email)
    {
        ...
        if ((!preg_match("/^[\\w]{1,}[\\w.+-]{0,}@[\\w-]{2,}([.][a-zA-Z]{2,}|[.][\\w-]{2,}[.][a-zA-Z]{2,})+$/", $email))) {
            throw new \InvalidArgumentException("invalid value for \$email when calling RecipientCreation., must conform to the pattern /^[\\w]{1,}[\\w.+-]{0,}@[\\w-]{2,}([.][a-zA-Z]{2,}|[.][\\w-]{2,}[.][a-zA-Z]{2,})+$/.");
        }
    ...
    public function setCompany($company)
    {
        ...
        if ((mb_strlen($company) > 38)) {
            throw new \InvalidArgumentException('invalid length for $company when calling RecipientCreation., must be smaller than or equal to 38.');
        }
        if ((mb_strlen($company) < 0)) {
            throw new \InvalidArgumentException('invalid length for $company when calling RecipientCreation., must be bigger than or equal to 0.');
        }
